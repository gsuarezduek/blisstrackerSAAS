...
POST   /api/projects/:id/meetings/:mid/start                 # inicia el cronómetro
POST   /api/projects/:id/meetings/:mid/finish               # finaliza el cronómetro (congela durationMins)
