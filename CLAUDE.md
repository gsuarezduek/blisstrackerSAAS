...
GET    /api/chat/channels                        # lista canales (materializa #general + canales de proyecto si faltan) con no-leídos/menciones
...
GET    /api/chat/channels/:id/messages            # ?before=<messageId>&limit=50 — paginado por cursor
