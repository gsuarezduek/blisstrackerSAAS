...
export default function ProposalsPanel({ leadId, companyName, currency, onChanged }) {
  ...
  return (
    <div className={card}>
      ...
      {modal && <ProposalModal leadId={leadId} companyName={companyName} currency={currency} proposal={modal.proposal} onClose={() => setModal(null)} onSaved={afterSaved} />}
    </div>
  )
}
