...
function promptForLink(editor) {
  ...
  const url = window.prompt('URL del link (dejar vacío para quitarlo)', previousUrl || 'https://')
...
export function Toolbar({ editor }) {
  ...
  return (
    <div className="flex items-center gap-0.5 px-2 py-1.5 border-b border-gray-200 dark:border-gray-600 flex-wrap bg-gray-50 dark:bg-gray-750 rounded-t-xl">
      ...
      <ToolBtn active={editor.isActive('link')} onClick={() => promptForLink(editor)} title="Insertar link (dejar vacío para quitarlo)">
