...
// Formulario de feedback (sugerencia/error), extraído de FeedbackButton para que
// también lo pueda abrir el menú "+" del Chat sin duplicar el flujo — el chat es
// para conversación, los reportes estructurados siguen pasando por acá.
