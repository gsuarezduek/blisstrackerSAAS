...
export default function PersonalTab({ loaded, weeklyEmail, dailyInsight, notesBoard, setWeeklyEmail, setDailyInsight, setNotesBoard }) {
    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border dark:border-gray-700 p-6">
        <div className="flex items-start justify-between gap-4 mb-5">
          ...
          <Toggle on={dailyInsight} onToggle={handleToggleInsight} disabled={togglingD || !loaded} />
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border dark:border-gray-700 p-6">
        ...
        <div className="flex items-start justify-between gap-4 py-4 border-b dark:border-gray-700">
          ...
          <Toggle on={weeklyEmail} onToggle={handleToggleWeekly} disabled={togglingW || !loaded} />
        </div>
        <div className="pt-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border dark:border-gray-700 p-6">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <Toggle on={notesBoard} onToggle={handleToggleNotesBoard} disabled={togglingN || !loaded} />
        </div>
      </div>
    </>
  )
