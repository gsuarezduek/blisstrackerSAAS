...
export const HOW_TO_CATALOG = {
  ...
  'portal.config': {
    ...
    body: [
      'Es un link público por proyecto (sin usuario del sistema) donde el cliente ve Informes y Briefs siempre, y — si lo habilitás acá — Datos en vivo, Contenido y Nube.',
      'Para Datos en vivo, Contenido y Nube el cliente necesita identificarse: pide un código de 6 dígitos por email (no usa contraseña) a uno de los Contactos que cargues en esta ficha.',
      'Nube muestra el mismo repositorio que ve el equipo (todas las carpetas y archivos del proyecto), en modo solo lectura: el cliente puede ver y descargar, pero no subir, mover ni borrar nada.',
