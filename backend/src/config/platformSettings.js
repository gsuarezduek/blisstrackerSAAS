...
const PLATFORM_SETTINGS = [
  ...
  {
    key:     'projectFilesMaxMbPerWorkspace',
    type:    'integer',
    default: 20480,
    min:     0,
    max:     1_000_000,
  ...
  {
    key:     'projectFilesPendingRetentionHours',
    type:    'integer',
    default: 24,
    min:     1,
    max:     720,
  ...
  {
    key:     'chatAttachmentMaxMbPerWorkspace',
    type:    'integer',
    default: 5120,
    min:     0,
    max:     1_000_000,
    group:   'operational',
    label:   'Storage de adjuntos del Chat por workspace (MB)',
    help:    'Tope de bytes acumulados en ChatAttachment (fotos/documentos adjuntos a mensajes del chat interno) por workspace. Se chequea al subir. 0 = ilimitado. Cuota independiente de Contenido y Nube — con la retención de 30 días (chatAttachmentRetentionDays) el uso ya se auto-acota, por eso el default es más bajo que las otras.',
  },
  {
    key:     'chatAttachmentRetentionDays',
    type:    'integer',
    default: 30,
    min:     1,
    max:     365,
    group:   'operational',
    label:   'Retención de adjuntos del Chat (días)',
