...
const VALID_TYPES = ['COMPLETED', 'BLOCKED', 'UNBLOCKED', 'ADDED_TO_PROJECT', 'TASK_COMMENT', 'TASK_MENTION', 'VACATION_REQUEST', 'VACATION_REVIEWED', 'LEAD_ASSIGNED', 'GAME_LAUNCHED', 'CHAT_MENTION', 'CONTENT_MENTION', 'CONTENT_APPROVED', 'CONTENT_CHANGES_REQUESTED', 'PORTAL_CLIENT_LOGIN', 'WHATSAPP_MESSAGE', 'BENEFIT_REQUEST', 'BENEFIT_REVIEWED']
