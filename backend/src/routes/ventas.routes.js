...
router.patch('/leads/:id/archive',      leads.archiveLead)
router.post('/leads/:id/actions',                leads.addAction)
router.patch('/leads/:id/actions/:actionId/resolve', leads.resolveAction)
router.delete('/leads/:id/actions/:actionId',     leads.deleteAction)
...
router.post('/leads/:id/research/:researchId/report',  research.generateReport)
router.patch('/leads/:id/research/:researchId/report', research.updateReport)
router.get('/leads/:id/proposals',      proposals.listProposals)
router.post('/leads/:id/proposals/brief', proposals.createBrief)
