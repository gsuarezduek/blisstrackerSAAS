...
const projectFiles = require('../controllers/projects/projectFiles.controller')
...
router.post('/:id/files/download-zip',      projectFiles.downloadZip)
router.get('/:id/files/:fileId/locate',     projectFiles.locateFile)
router.post('/:id/files/:itemId/public-link',   projectFiles.createPublicLink)
router.delete('/:id/files/:itemId/public-link', projectFiles.revokePublicLink)
