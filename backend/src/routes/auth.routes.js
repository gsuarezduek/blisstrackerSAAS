...
const { login, me, forgotPassword, resetPassword, verifyEmailChange, connectGoogleWithToken, googleLogin, switchWorkspace, recordLogin, logout } = require('../controllers/auth.controller')
