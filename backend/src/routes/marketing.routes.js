...
router.get('/integrations/facebook/callback',  metaIntegrations.handleFacebookCallback)
...
router.get('/projects/:id/instagram/scrape-debug',    instagram.scrapeDebug)
...
router.delete('/projects/:id/tiktok/snapshots/:month',    tiktok.deleteSnapshot)
router.get('/projects/:id/tiktok/followers',              tiktok.getFollowerLog)
router.get('/projects/:id/tiktok',                        tiktok.getMetrics)

// YouTube (usa el OAuth de Google con type=google_youtube)
router.get('/projects/:id/youtube/snapshots',             youtube.getSnapshots)
router.post('/projects/:id/youtube/snapshots',            youtube.saveSnapshot)
router.delete('/projects/:id/youtube/snapshots/:month',   youtube.deleteSnapshot)
router.get('/projects/:id/youtube/followers',             youtube.getFollowerLog)
router.get('/projects/:id/youtube',                       youtube.getMetrics)
...
router.delete('/projects/:id/linkedin/snapshots/:month', linkedin.deleteSnapshot)
...
// Facebook (Páginas)
router.get('/integrations/facebook/auth-url',            metaIntegrations.getFacebookAuthUrl)
router.post('/projects/:id/integrations/facebook/connect-token',  metaIntegrations.connectFacebookToken)
router.post('/projects/:id/integrations/facebook/connect-scrape', facebook.connectScrape)
router.get('/projects/:id/facebook/snapshots',           facebook.getSnapshots)
router.post('/projects/:id/facebook/snapshots',          facebook.saveSnapshot)
router.delete('/projects/:id/facebook/snapshots/:month', facebook.deleteSnapshot)
...
router.get('/projects/:id/report-sections-config',                             monthlyReport.getReportSectionsConfig)
router.patch('/projects/:id/report-sections-config',                           monthlyReport.updateReportSectionsConfig)
...
router.post('/projects/:id/reports/:month/check-readiness',                    monthlyReport.getGenerationReadiness)
...
router.get('/summary/youtube',     summary.getYouTubeSummary)
router.get('/summary/linkedin',    summary.getLinkedinSummary)
router.get('/summary/facebook',    summary.getFacebookSummary)
router.post('/summary/rrss/:platform/refresh', summary.refreshRrssSummary)
